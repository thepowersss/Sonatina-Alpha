...
var _abc2svg = require('abc2svg/abc2svg-1.js');
...
var Abc2Svg = function (_PureComponent) {
  ...
  function Abc2Svg() {
    ...
    return _ret = (_temp = (_this2 = _possibleConstructorReturn(this, _PureComponent.call.apply(_PureComponent, [this].concat(args))), _this2), _this2.state = {
      ...
      _this2.setState({ containerWidth: '%%pagewidth ' + window.getComputedStyle((0, _reactDom.findDOMNode)(_this2)).width + '\n' });
  ...
  Abc2Svg.prototype.render = function render() {
    ...
    var abc = new _abc2svg.Abc(this.abcCallbacks);
    ...
    return _react2.default.createElement(
      'div',
      { style: { width: '100%' } },
      _react2.default.createElement('div', { className: 'abc2svg-result', style: { width: '100%' },
        dangerouslySetInnerHTML: { __html: this.abcCallbacks.abc_svg_output }
      }),
      showErrors && this.abcCallbacks.abc_error_output !== '' && _react2.default.createElement('div', { className: 'abc2svg-errors', style: { width: '100%', textAlign: 'center' },
...
Abc2Svg.propTypes = process.env.NODE_ENV !== "production" ? {
  abcNotation: _propTypes2.default.string,
