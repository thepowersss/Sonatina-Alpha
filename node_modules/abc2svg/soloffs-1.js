...
break}}
return}
of(cmd,parm)},set_sym_glue:function(of,width){var s,t,tsfirst=this.get_tsfirst(),soloffs=this.cfmt().soloffs;of(width)
if(!soloffs)
return
...
s.x=soloffs[t]}},set_hooks:function(abc){abc.set_sym_glue=abc2svg.soloffs.set_sym_glue.bind(abc,abc.set_sym_glue);abc.set_format=abc2svg.soloffs.set_fmt.bind(abc,abc.set_format)}}
