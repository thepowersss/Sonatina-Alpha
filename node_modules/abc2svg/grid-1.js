...
function build_grid(s,font){var i,k,l,nr,bar,w,hr,x0,x,y,yl,lc='',chords=s.chords,bars=s.bars,parts=s.parts||[],wmx=s.wmx,cells=[],nc=grid.n
...
beat=C.BLEN/8*3
return beat}
function build_chords(sb){var s,i,w,bt,rep,bars=[],chords=[],parts=[],chord=[],beat=get_beat(voice_tb[0].meter),wm=voice_tb[0].meter.wmeasure,cur_beat=0,beat_i=0,wmx=0
bars.push('|')
