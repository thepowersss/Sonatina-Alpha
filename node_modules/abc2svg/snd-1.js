...
for(s=po.s_cur;s;s=s.ts_prev){if(s.parts){po.i_p=0
return}
s_p=s.part1
if(!s_p||!s_p.p_s)
continue
...
var abcsf2=[]
function Audio5(i_conf){var po,conf=i_conf,empty=function(){},errmsg,ac,gain,parser,presets,instr=[],params=[],rates=[],w_instr=0
var b64d=[]
